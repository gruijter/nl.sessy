...
class SessyBaseDevice extends Device {
  ...
  // dongle-only firmware state (p1/ct/modbus); sessy overrides this with the dongle+battery variant
  ...
  // p1/ct only; sessy/pv don't register a set_grid_target flow action against this
